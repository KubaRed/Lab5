...
public class Lab5 extends GLJPanel implements GLEventListener, KeyListener{
	...
	public void Added_Poligon(GL2 gl2, double size)
	{
		...
		gl2.glTranslated(0,0,0);
		Triangle(gl2,1.0f, 0.0f, 1.0f );
		gl2.glPopMatrix();
		
		gl2.glPushMatrix();
		gl2.glRotated(180, 0, 1, 0);
		gl2.glTranslated(0,0,0);
		Triangle(gl2,1.0f, 1.0f, 1.0f );
		gl2.glPopMatrix();
		
		gl2.glPushMatrix();
		gl2.glRotated(-60, 0, 1, 0);
		gl2.glTranslated(0,0,0);
		Triangle(gl2,0.0f, 0.0f, 1.0f );
		gl2.glPopMatrix();
		
		gl2.glPushMatrix();
		gl2.glRotated(-120, 0, 1, 0);
		gl2.glTranslated(0,0,0);
		Triangle(gl2,1.0f, 1.0f, 0.0f );
		gl2.glPopMatrix();
	...
	public void walec (GL2 gl2,int a, double size_x,double size_y , double size_z ) 
	{
	int n=a*100;
